...
import { FaMapMarkerAlt, FaMoneyBillAlt, FaRegClock } from "react-icons/fa";
      ...
      <div className="container mx-auto px-4 md:px-12 lg:px-16">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="flex items-center">
              <FaMapMarkerAlt className="text-green-800 mr-2" />
              <p className="text-lg text-gray-700 capitalize">{job.district}, {job.city}</p>
            </div>
            <div className="flex items-center">
              <FaRegClock className="text-green-800 mr-2" />
              <p className="text-lg text-gray-700">Posted on: {new Date(job.jobPostedOn).toLocaleDateString()}</p>
            </div>
          </div>
